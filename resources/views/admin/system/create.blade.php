                    ...
                    <form action="{{url('admin/system')}}" id="frm" class="form-horizontal" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="webtitle" value="" placeholder="请输入网站标题">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="keywords" value="" placeholder="请输入网站关键词">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="description" name="description" rows="4"  placeholder="请输入网站描述"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" size="50" class="form-control" style="width:400px; float: left;" name="img" value="" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <script src="{{asset('/admin/fileuplode/js/jquery.iframe-transport.js')}}"></script>
                                    <script src="{{asset('/admin/fileuplode/js/jquery.fileupload.js')}}"></script>
                                    <input type="text" size="50" class="form-control" style="width:400px; float: left;" value="" name="weixin" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <script src="{{asset('/admin/fileuplode/js/jquery.iframe-transport.js')}}"></script>
                                    <script src="{{asset('/admin/fileuplode/js/jquery.fileupload.js')}}"></script>
                                    <input type="text" size="50" class="form-control" style="width:400px; float: left;" value="" name="weibo" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="weixinurl" value="" placeholder="请输入微信链接">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="weibourl" value="" placeholder="请输入微博链接">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="icp" value="" placeholder="请输入网站备案编号">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="tongji" name="tongji" rows="4"  placeholder="请输入网站统计代码"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="col-md-11" style="width: 100%; padding: 0px;">
                                        <textarea name="about" id="about" value=""></textarea>
                                    </div>
                                    <!-- 富文本编辑器结束 -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <!-- 富文本编辑器 -->
                                    <div class="col-md-11" style="width: 100%; padding: 0px;">
                                        <textarea name="contact" id="contact" value=""></textarea>
                                    </div>
                                    <!-- 富文本编辑器结束 -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <!-- 富文本编辑器 -->
                                    <div class="col-md-11" style="width: 100%; padding: 0px;">
                                        <textarea name="follow" id="follow" value=""></textarea>
                                    </div>
                                    <!-- 富文本编辑器结束 -->
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <button type="submit" id="btn" class="btn btn-info pull-right">保存信息</button>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
