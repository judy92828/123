        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{url('admin/advert')}}" id="frm" class="form-horizontal" method="post">
                        {{csrf_field()}}
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" value="" style="width: 500px;">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="" name="url" style="width: 500px;" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="position_id" style="width:30%;">
                                        @foreach($aps as $ap)
                                          <option value="{{$ap->position}}">{{$ap->name}}</option>
                                         @endforeach
                                    </select>
                                </div>
                            </div>
